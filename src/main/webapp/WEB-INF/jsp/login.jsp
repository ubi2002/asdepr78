	...
	<jsp:body>
        <div class="card form-signin-container">
            <div class="card-body">
                <form:form method="POST" class="col-sm needs-validation"
                    ...
                    <div class="bmd-form-group">
                        ...
                        <div class="input-group">
                            <form:input type="text" path="email"
								id="inputEmail" class="form-control" required="true" />
                    ...
                    <div class="bmd-form-group">
                        <label for="inputPassword"
							class="bmd-label-floating">Password</label>
                        <div class="input-group">
                    ...
                    <button
						class="btn btn-lg btn-block btn-raised btn-primary" type="submit">Login</button>
                </form:form>
                ...
                <div class="col-sm text-center">
	                <form:form method="POST" action="/clear">
	                    <button
								class="btn btn-lg btn-block btn-raised btn-warning" type="submit">Clear all exam</button>
	                </form:form>
                </div>
            </div>
        </div>
