...
@Entity
@Table(name = "submissions", indexes = { @Index(columnList = "exam_id,user_id", unique = true) })
...
public final class Submission extends BaseEntity {
	...
	@Column(name = "`correct_count`", nullable = false, columnDefinition = "TINYINT UNSIGNED")
	@ColumnDefault("0")
	private int correctCount;

	@Column(name = "`incorrect_count`", nullable = false, columnDefinition = "TINYINT UNSIGNED")
	@ColumnDefault("0")
