...
public final class Exam extends BaseEntity {
	...
	@Column(name = "`submitted_count`", nullable = false, columnDefinition = "INT UNSIGNED")
	@ColumnDefault("0")
	private Integer submittedCount = 0;

	@Column(name = "`reviewed_count`", nullable = false, columnDefinition = "INT UNSIGNED")
	@ColumnDefault("0")
	...
	public String toString() {
		return "Exam{" + "id=" + getId() + ", title='" + title + '\'' + ", desc='" + desc + '\'' + ", startedAt="
				+ startedAt + ", finishedAt=" + finishedAt + ", duration=" + duration + ", questions=" + questions
				+ '}';
	}
}
