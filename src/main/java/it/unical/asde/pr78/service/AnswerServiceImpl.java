...
public class AnswerServiceImpl implements AnswerService {
	...
	/**
	 * Need to check the questionIds of submitted answers with the questions of the
	 * exam
	 */
	@Override
	public List<Answer> submitAnswers(User student, Map<Long, String[]> answers, Submission submission)
		...
		for (Answer answer : refinedAnswers) {
			if (answer.getQuestion() == null) {
				String error = String.format(
						"You have answered for some invalid questions. Maybe these questions do not belong to the exam '%s'",
		...
		try {
			...
			throw new InvalidAnswerException(
					"There is an unexpected error when saving your answers. Please try again.");
		}
	...
	public Question updateCorrectness(Exam exam, Submission submission, Long questionId, boolean isCorrect)
		...
		if (answers == null || answers.isEmpty()) {
			String error = String.format("No answer is found for question '%s' by student ''%s", question.getTitle(),
